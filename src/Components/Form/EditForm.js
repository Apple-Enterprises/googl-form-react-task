...
function EditForm(props) {
  ...
  const clipToClipboard = () => {
    navigator.clipboard.writeText(
      window.location.origin + "/s/" + formDetails.id
    );
    handleClickOfAlert();
    handleClose();
  };
            ...
            >
              ...
              <DialogContent>
                ...
                {/* <div style={{padding: '7px', display: 'flex'}}>
                  <Typography variant="body1">{window.location.origin + "/s/" + formDetails.id}</Typography>
                    
                  <IconButton onClick={() =>  navigator.clipboard.writeText(window.location.origin + "/s/" + formDetails.id)}  >
                    <MoreIcon />
                  </IconButton>
                  </div> */}
